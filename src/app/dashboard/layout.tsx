            ...
            <div className="hidden md:block border-r bg-muted/40">
                <div className="flex-full max-h-screen flex-col gap-2">
                    <div className="flex h-14 items-center border-b px-4 lg:h-[60px] lg:px-6">
                        <Link href="/" className="flex items-center gap-2 "> <Image src="/logo.png" width={30} height={30} alt="logo" /> 
                        <p className="text-primary font-bold text-xl">Scheduler</p></Link>
                        ...
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <Button variant="secondary" size="icon" className="rounded-full">
                                    <img src={session?.user?.image as string} alt="avatar" className="w-full h-full rounded-full" width={20} height={20} />
                                </Button>
                            </DropdownMenuTrigger>
